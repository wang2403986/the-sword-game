...
function integrateWasmJS() {
    ...
    function doNativeWasm(global, env, providedBuffer) {
        ...
        function receiveInstance(instance, module) {
            ...
            var obj = {exports: { memory: Module.wasmMemory } };
            Object.keys(Module).forEach(function(key){
            	if(key.charAt(0)==='_') obj.exports[key.substring(1)] = Module[key];
            });
            iPathFinder.start(obj);
        }
...
STATICTOP = STATIC_BASE + 1883056;
__ATINIT__.push();
var STATIC_BUMP = 1883056;
...
Module["asm"] = asm;
var _birthLocation = Module["_birthLocation"] = (function() {
    return Module["asm"]["b"].apply(null, arguments)
}
);
var _findPath = Module["_findPath"] = (function() {
    return Module["asm"]["c"].apply(null, arguments)
}
);
var _findPathAttack = Module["_findPathAttack"] = (function() {
...
var _getPath = Module["_getPath"] = (function() {
